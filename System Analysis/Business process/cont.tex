...
% ---------------------- RENT PROCESS ----------------------
\subsubsection{Quy trình thuê xe}
\label{subsec:rent-activity}
\small\textit{UC-02, UC-03, UC-04 (Hình \ref{fig:rent-activity})}
\subsubsection*{a. Mục tiêu:}
Cho phép người dùng tìm kiếm, xem thông tin và đặt thuê xe máy điện trong khu vực mong muốn thông qua ứng dụng.
\subsubsection*{b. Actor chính:} Người thuê (Renter)
\subsubsection*{c. Các bước chính:}
...
\subsubsection*{d. Luồng thay thế:}
...
% ---------------------- RETURN PROCESS ----------------------
\subsubsection{Quy trình trả xe}
\label{subsec:return-activity}
\small\textit{UC-05, UC-06, UC-07 (Hình \ref{fig:return-activity})}
\subsubsection*{a. Mục tiêu:}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Images/Activity/rent.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Images/Activity/return.png}
    \caption{Returning Activity Diagram}
    \label{fig:return-activity}
\end{figure}

% ---------------------- REGISTER VEHICLE ----------------------
\subsubsection{Quy trình đăng ký xe cho thuê}
\label{subsec:regis-activity}
\small\textit{UC-08 (Hình \ref{fig:regis-activity})}
\subsubsection*{a. Mục tiêu:}
...
\subsubsection*{b. Actor chính:} Chủ xe (Owner)
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Images/Activity/submit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Images/Activity/owner_management.png}
    \caption{Manage Vehicle Activity Diagram}
    \label{fig:manage-bike-activity}
\end{figure}
\subsubsection{Quy trình quản lý xe của chủ}
\label{subsec:manage-bike-activity}
\small\textit{UC-09 (Hình \ref{fig:manage-bike-activity})}
\subsubsection*{a. Mục tiêu:}
...
% ---------------------- ADMIN PROCESS ----------------------
\subsubsection{Quy trình quản trị hệ thống}
\label{subsec:admin-activity}
\small\textit{UC-10, UC-11, UC-12 (Hình \ref{fig:admin-activity})}
\subsubsection*{a. Mục tiêu:}
...
\subsubsection*{b. Actor chính:} Quản trị viên (Admin)
\subsubsection*{c. Các bước chính:}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Images/Activity/admin.png}
