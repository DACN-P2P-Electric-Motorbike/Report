...
\subsubsection{Tìm và Đặt thuê xe}
\small\textit{UC-02, UC-03, UC-04 (Hình \ref{fig:rent-sequence})}
\subsubsection*{a. Mô tả tổng quát}
Người thuê tìm kiếm xe điện gần vị trí hiện tại, xem chi tiết và tiến hành đặt thuê.
\subsubsection*{b. Thành phần và vai trò}
...
\subsubsection*{c. Hành vi hệ thống}
...
\subsubsection{Kết thúc chuyến đi \& Đánh giá}
\small\textit{UC-05, UC-06, UC-07 (Hình \ref{fig:return-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
\subsubsection{Đăng ký xe cho thuê}
\small\textit{UC-08 (Hình \ref{fig:regis-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
\small\textit{UC-09 (Hình \ref{fig:manage-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
\subsubsection{Báo cáo sự cố}
\small\textit{UC-16 (Hình \ref{fig:accident-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
\small\textit{UC-17 (Hình \ref{fig:notification-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
\subsubsection{Duyệt xe / Quản trị hệ thống}
\small\textit{UC-10 (Hình \ref{fig:admin-approve-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
1(1) Trường hợp có lỗi kết nối Database, hệ thống thông báo lỗi trên giao diện. \\
1(2) (Mở rộng) Nếu Admin phát hiện xe vi phạm, Admin có thể chọn "Khóa xe", hệ thống cập nhật status="locked" và gửi thông báo cảnh báo cho Owner.
\subsubsection{Xem báo cáo / Thống kê}
\small\textit{UC-11 (Hình \ref{fig:admin-statistic-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
\small\textit{UC-12 (Hình \ref{fig:admin-user-management-sequence})}
\subsubsection*{a. Mô tả tổng quát}
...
\subsubsection{Hệ thống Trust Score}
\small\textit{UC-13 (Hình \ref{fig:trust-score-sequence})}
\subsubsection*{a. Mô tả tổng quát}
